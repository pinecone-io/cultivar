...
def _pregrade_autofail(
    ...
    # (the hybrid-grading path for tasks we can't execute end-to-end). Lives here
    # rather than in grade_one so every backend shares it: code that did not run
    # has failed, and that verdict must not depend on which grader was selected.
